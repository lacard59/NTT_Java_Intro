...
public class SaleTest {
	...
	public static void main(String[] args) {
		setupSale();
        CartDisplayUtility.writeItemAsText(sale);
        System.out.println("wIAS");
        CartDisplayUtility.readItemsAsText();
        System.out.println("rIAS");
        CartDisplayUtility.writeItemsAsObjects(sale);
        System.out.println("wIAO");
        CartDisplayUtility.readItemsAsObjects();
        System.out.println("rIAO");
        CartDisplayUtility.writeSalesAsObject(sale);
        System.out.println("wSAO");
        CartDisplayUtility.readSaleAsObject();
        System.out.println("rSAO");
//		testCalcTotalCost();
//		setupAddAnotherItem();
//		testCalcTotalCost();
//		testGetCust();
